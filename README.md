...
| POST   | /saveList         | Saves a list of sequences with their meta into a file         | **sequences** (Array\<string> - an list of sequence names), **meta** (_Array\<object> - a list of meta-data_) |
